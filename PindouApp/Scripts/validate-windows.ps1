...
Assert-FileContains $projectSpec 'PRODUCT_NAME:\s*PindouApp' '测试宿主的构建产物名未固定为 PindouApp'
Assert-FileContains $projectSpec 'INFOPLIST_KEY_CFBundleDisplayName:\s*豆图' '用户可见应用名称未保留为豆图'
